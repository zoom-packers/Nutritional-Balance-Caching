...
@Mod(NutritionalBalance_Caching.MODID)
public class NutritionalBalance_Caching {

    // Define mod id in a common place for everything to reference
    public static final String MODID = "nutritional_balance_caching";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "nutritional_balance_caching" namespace

    public NutritionalBalance_Caching() {
